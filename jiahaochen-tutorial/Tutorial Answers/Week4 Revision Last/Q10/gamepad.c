...
int main(int argc, char** argv) {
  ...
  // This program will create a file that the process and send data to that file
  ...
  if(f != NULL) {
      ...
      // After receiving the packet, the reading process needs to output what buttons have been pressed and the current state of the analog sticks
		  read_gamepad(&u_data);
      // send data to that file
